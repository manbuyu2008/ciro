...
(function ($) {
        ...
        init: function (options, swfUploadOptions) {
            ...
            return this.each(function () {
                ...
                var swfUploadSettings = {
                    ...
                    file_queued_handler_ex: handlers.onSelectEx,
                ...
                if (flashInstalled) {
                    ...
                    if (settings.onInitEx) settings.onInitEx.call($this, swfuploadify,swfUploadSettings);
    ...
    var handlers = {
        ...
        onSelectEx: function (file,swfuploadify) {
            //供初始化列表添加附件使用 huangxl
            ...
            for (var n in swfuploadify.queueData.files) {
                ...
                if (queuedFile.uploaded != true && queuedFile.name == file.name) {
                    ...
                    if (!replaceQueueItem) {
                        ...
                        swfuploadify.queueData.filesCancelled++;
                        return false;
                    } else {
                        $('#' + queuedFile.id).remove();
                        swfuploadify.cancelUpload(queuedFile.id);
                        swfuploadify.queueData.filesReplaced++;
                    }
                }
            }
   ...
   <span class="fileName">${fileName} (${fileSize})</span><span class="data"> - 上传成功</span>\
   <div class="uploadify-progress">\
      <div class="uploadify-progress-bar" style="width: 100%;"><!--Progress Bar--></div>\
            ...
            swfuploadify.queueData.uploadsSuccessful = swfuploadify.queueData.uploadsSuccessful+1;
            swfuploadify.queueData.queueBytesUploaded += file.size;
            // Call the user-defined event handler
