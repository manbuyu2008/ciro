...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/easyui/tooltip.css">
    ...
    <script type="text/javascript" src="/resources/js/easyui/jquery.easyui.src.js"></script>
    <script type="text/javascript" src="/resources/js/coco/coco.src.js"></script>
    <script type="text/javascript" src="/resources/js/coco/coco.plugin.tree.js"></script>
    <script type="text/javascript" src="/resources/js/coco/coco.plugin.list.js"></script>
    <script type="text/javascript" src="/resources/js/coco/coco.plugin.combo.js"></script>
    <link rel="stylesheet" href="/resources/css/common.css" type="text/css">
    <link rel="stylesheet" type="text/css" href="/resources/css/themes/sys/default.css"/>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/themes/sys/bootstrap/easyui.css"
          id="swicth-style"/>
    <link rel="stylesheet" type="text/css" href="/resources/css/themes/sys/icon.css"/>
    <script type="text/javascript">
