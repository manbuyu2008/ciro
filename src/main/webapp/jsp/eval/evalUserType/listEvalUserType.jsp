...
<script type="text/javascript" src="<%=CONTEXT_PATH%>/jsp/eval/evalUserType/listEvalUserType.js"></script>
    ...
    <div id="center-div" class="easyui-layout" fit="true">
        <div region="north" id="queryForm" title="查询条件" style="overflow:hidden; height: 65px;"
            ...
            <table id="form" class="p_tbl" cellspacing="1" cellpadding="0">
                <tbody>
                <input type="hidden" id="evalUserTypeId" name="evalUserTypeId" value="">
                <tr class="p_tr">
                    <td nowrap class='p_td_lbl' align='right' style='width:10%'>编码:</td>
                    <td nowrap class='coco_txt' align='left' style='width:20%'>
                        <input type="text" id="typeCode" name="typeCode" class="easyui-validatebox coco_input"
                               value="">
                    <td nowrap class='p_td_lbl' align='right' style='width:10%'>名称:</td>
                    <td nowrap class='coco_txt' align='left' style='width:20%'>
                        <input id="typeName" name="typeName" class="easyui-validatebox coco_input"
                               value=""/>
                    </td>
                </tr>
                </tbody>
...
<div id="evalUserType_dialog" style="padding:5px; width:550px;height:500px; ">
