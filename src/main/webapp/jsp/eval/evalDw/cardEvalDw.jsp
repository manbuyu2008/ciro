...
<script type="text/javascript" src="<%=CONTEXT_PATH%>/jsp/eval/evalDw/cardEvalDw.js"></script>
...
<div region="north" style="overflow:hidden;height:35px;" border="false">
    <div id="toolbar" class="coco_toolbar">
        ...
        <c:if test="${bean.status==99}">
            <a id="cancel" href="#" class="easyui-linkbutton" iconCls='icon-reject' plain="false"
               onclick="page.cancel()">取回</a>
        </c:if>
        <a id="print" href="#" class="easyui-linkbutton" iconCls='icon-print' plain="false"
           onclick="page.print()">打印</a>
...
<script type="text/javascript">
    ...
    var bc = <%=EvalFlowStatusEnum.KP_DW_SAVE.getValue()%>;
    var tj = <%=EvalFlowStatusEnum.KP_DW_SUBMIT.getValue()%>;
