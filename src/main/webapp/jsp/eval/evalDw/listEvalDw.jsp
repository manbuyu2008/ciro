...
<script type="text/javascript" src="<%=CONTEXT_PATH%>/jsp/eval/evalDw/listEvalDw.js"></script>
...
<div region="north" style="overflow:hidden;height:35px;" border="false">
    <div id="toolbar" class="coco_toolbar">
        ...
        <shiro:hasPermission name="evalDw:edit">
            <input id="permissionEdit" name="permissionEdit" value="1" type="hidden"/>
        </shiro:hasPermission>
        <shiro:lacksPermission name="evalDw:edit">
        ...
        <shiro:hasPermission name="evalDw:edit">
            <a id="btn" href="#" class="easyui-linkbutton" iconCls='icon-savesubmit' plain="false"
               onclick="page.autoSubmit()">批量审核</a>
        </shiro:hasPermission>
...
<div region="center" border="false">
    <div id="center-div" class="easyui-layout" fit="true">
        <div region="north" id="queryForm" title="查询条件" style="overflow:hidden; height: 65px;"
            ...
            <input type="hidden" id="listType" name="listType" value="dw"/>
