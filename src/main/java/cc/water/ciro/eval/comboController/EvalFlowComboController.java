...
public class EvalFlowComboController extends ListComboController {

    @Autowired @Qualifier("evalFlowComboService")
    private IComboService evalFlowComboService;
    ...
    public void comboData(HttpServletRequest request, HttpServletResponse response, Model model) {
              super.comboData(context,model,evalFlowComboService);
    }
    ...
    public void findTextsById(HttpServletRequest request, HttpServletResponse response, Model model) {
        super.findTextsById(context,model,evalFlowComboService);
    }
