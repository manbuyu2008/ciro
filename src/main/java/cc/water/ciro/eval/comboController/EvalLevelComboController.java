...
public class EvalLevelComboController extends ListComboController {

    @Autowired @Qualifier("evalLevelComboService")
    private IComboService evalLevelComboService;
    ...
    public void comboData(HttpServletRequest request, HttpServletResponse response, Model model) {
              super.comboData(context,model,evalLevelComboService);
    }
    ...
    public void findTextsById(HttpServletRequest request, HttpServletResponse response, Model model) {
        super.findTextsById(context,model,evalLevelComboService);
    }
