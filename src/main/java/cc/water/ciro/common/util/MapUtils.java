...
public class MapUtils extends org.apache.commons.collections.MapUtils {
     ...
     * @throws NoSuchMethodException
     */
    public static List<Map<String, String>> toList(List list,List<String> containKeyList,List<String> outKeyList) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        if (list != null && !list.isEmpty()) {
            for (Object object : list) {
                ...
                if(containKeyList!=null&&!containKeyList.isEmpty()){
                    ...
                    return  retList;
                }else if(outKeyList!=null&&!outKeyList.isEmpty()){
                    for(String key:outKeyList){
                        if(map.containsKey(key)) {
                            map.remove(key);
                        }
                        retList.add(map);
