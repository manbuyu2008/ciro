...
//        System.out.println("1-2-1".indexOf("1-1"));
...
//
//        String password =  new SimpleHash("md5","XXXX单位"+"ciroPwd!@#$!@#$%!"+"vilkjuye",(Object)null,2).toHex();
//
//        String platKey =  new SimpleHash("md5","XXXX单位"+ DES.strDefaultKey+ CoreConsts.PWD_REG_STRING,(Object)null,5).toHex();
//        System.out.println(password);
//        System.out.println(des.encrypt(test)+","+platKey);
         //des.encrypt(test),platKey
        Role role=new Role();
        role.setId((int) 12l);
